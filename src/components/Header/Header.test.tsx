...
describe(Header, () => {
  ...
  it('should render header with search bar by default', () => {
    render(<Header selectedMovie={null} onSearch={onSearch} onAddMovieSubmit={onAddMovieSubmit} onSelectedMovieReset={onSelectedMovieReset}/>);
  ...
  it('should render header with movie details when movie selected', () => {
    render(<Header selectedMovie={movieMock} onSearch={onSearch} onAddMovieSubmit={onAddMovieSubmit} onSelectedMovieReset={onSelectedMovieReset}/>);
